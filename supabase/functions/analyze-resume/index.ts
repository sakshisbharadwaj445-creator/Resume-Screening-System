...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are an expert HR resume screening assistant. Analyze the candidate's resume against the given job title and description. You MUST respond with valid JSON only, no markdown, no extra text.

Return this exact JSON structure:
{
  "matchPercentage": <number 0-100>,
  "suitable": <boolean, true if matchPercentage >= 60>,
  ...
  "suggestions": [<array of 2-4 actionable suggestions to improve the resume for this role>]
}

Be fair and thorough. Consider skills, experience, education, and keywords.`;
